 ...
 */
async function executeClearImages(context: SlashCommandContext): Promise<SlashCommandResult> {
  try {
 ...
 */
export function getAvailableSlashCommands(): Array<{ command: string; description: string }> {
  return [
    {
