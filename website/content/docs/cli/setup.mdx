...
✓ Installed ralph-tui-create-beads-mcp
...
/ralph-tui-create-beads  # Convert an existing PRD to Beads issues (CLI version)
/ralph-tui-create-beads-mcp  # Convert an existing PRD to Beads issues (MCP version)
```
