...
- **Skills in Your Agent**: Use the bundled skills (`/ralph-tui-prd`, `/ralph-tui-create-json`, `/ralph-tui-create-beads`, `/ralph-tui-create-beads-mcp`) directly in your agent for PRD creation and task conversion
