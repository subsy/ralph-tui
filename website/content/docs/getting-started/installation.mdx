...
Ralph TUI includes bundled skills for PRD creation and task conversion that integrate with your AI agent. These are installed automatically during setup, but you can manage them manually:
...
Skills are installed to your agent's skills directory (e.g., `~/.claude/skills/` for Claude Code) and become available automatically.

<Callout type="tip">
Use `ralph-tui skills install --force` after upgrading ralph-tui to ensure you have the latest skill versions.
</Callout>
